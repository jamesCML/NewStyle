...
public class AES {
    ...
    private String mGloblePassword = "sz@zwcxkj!2015&*";// key必须为16位，可更改为自己的key
    ...
    public AES() {
        ...
        byte[] skAsByteArray;
        try {
            skAsByteArray = mGloblePassword.getBytes("ASCII");
    ...
    public byte[] decrypt(byte[] ciphertext_base64) {
